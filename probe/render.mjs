...
const seed = process.argv[2] || 'fastroads-01';
...
await sleep(4000);
await js(`(async()=>{const g=window.__fastroads;
...
for (let i = 0; i < 3; i++) {
  ...
  console.log('  ' + await js(`(()=>{const g=window.__fastroads;
...
const errs = await js(`(()=>{const g=window.__fastroads;
